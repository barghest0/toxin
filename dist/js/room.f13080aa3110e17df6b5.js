  ...
  var t,
    e = {
      394: function (t, e, n) {
        ...
        var m = (function () {
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  this.data = {
                    labels: this.labels,
                    datasets: [
                      { data: this.votes, backgroundColor: this.backgroundColors },
                    ],
                  };
                },
              },
              {
                ...
                value: function () {
                  ...
                  this.options =
                    ...
                    v(t, 'elements', {
                      responsive: !0,
                      center: { votesCount: this.totalVotes, votes: 'ГОЛОСОВ' },
                    }),
                    v(t, 'layout', { padding: { bottom: -5 } }),
                    v(t, 'plugins', {
                      legend: {
                        position: window.innerWidth >= 450 ? 'right' : 'bottom',
                        doughnutMode: !0,
                        align: window.innerWidth >= 450 ? 'end' : 'center',
                        reverse: !0,
                        labels: {
                          boxWidth: 8,
                          boxHeight: 8,
                  ...
                  this.plugins = [
                    {
                      beforeDraw: function (e) {
                        var n = e.ctx,
                          ...
                          o = i.width,
                          r = i.height;
                        n.save(), (n.fillStyle = '#BC9CFF');
                        var a = o / 2,
                          s = r / 2;
                        (n.font = 'bold 12px Montserrat'),
                          (n.textAlign = 'center'),
                          n.fillText('ГОЛОСОВ', a, s + 20),
                          (n.font = 'bold 24px Montserrat'),
                          n.fillText(t.totalVotes, a, s);
                      },
                    },
                  ];
                },
              ...
              {
                key: 'changeLegendPositionToRight',
                value: function () {
        ...
        var k = '.js-header__burger',
          C = '.js-header__burger-nav',
          w = 'active',
          $ = n(563);
        function T(t, e) {
          for (var n = 0; n < e.length; n++) {
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: 'setBurgerNav',
                value: function () {
                  this.$burgerNav = this.$container.find(C);
                },
              },
              {
                key: 'attachListeners',
              ...
              },
              {
                ...
                value: function (t) {
                  $(t.currentTarget).toggleClass(w), $(C).toggleClass(w);
                },
              },
              {
                key: 'closeBurgerAfterDocumentClick',
                value: function (t) {
                  t.target.closest(k) || this.$container.removeClass(w);
                },
              },
            ]) && T(e.prototype, n),
            Object.defineProperty(e, 'prototype', { writable: !1 }),
            ...
            return (
              ...
              (n = [
                ...
                },
                {
                  ...
                  value: function () {
                    new D.Z(this.datepicker, this.params);
                  },
                },
              ]) && A(e.prototype, n),
              Object.defineProperty(e, 'prototype', { writable: !1 }),
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  e.classList.contains(M) ? (n -= 1) : (n += 1),
                    e.classList.toggle(M),
                    (e.innerHTML = n);
                },
              },
            ]) && N(e.prototype, n),
