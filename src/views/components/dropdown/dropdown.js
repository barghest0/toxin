...
$('.iqdropdown_guests').iqDropdown({
	...
	setSelectionText: function (itemCount, totalItems) {
		if (!totalItems) {
			...
			$('input[name=guests]').val(itemCount['adult'] + itemCount['child'] + itemCount['newborns']);
		}

		console.log(this);
		let resString = itemCount['adult'] + itemCount['child'] + itemCount['newborns'];
...
$('.iqdropdown-button, .button-increment, .button-decrement').prop('type', 'button');
