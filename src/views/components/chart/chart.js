...
if (impressions) {
	...
	const greatValue = +document.querySelector('.chart__vote_great').dataset.value;
	const goodValue = +document.querySelector('.chart__vote_good').dataset.value;
	const satisfiedValue = +document.querySelector('.chart__vote_satisfied').dataset.value;
	const disappointedValue = +document.querySelector('.chart__vote_disappointed').dataset.value;
	...
	const data = {
		datasets: [
			{
				data: values,
				backgroundColor: [purpleGradient, greenGradient, yellowGradient, blackGradient],
			},
		],
	};
	const options = {
